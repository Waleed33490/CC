...
namespace GalaxyShooterGame
{
    internal class Program
    {
        ...
        static void Render()
        {
            ...
            // Display background (using ASCII-style)
            DrawBackground();
            ...
            // Reset color after drawing bullets
            Console.ResetColor();
        ...
        // Draw the background using ASCII characters
        static void DrawBackground()
        {
            // A simple ASCII pattern for the background, you can replace it with a more advanced image logic
            string[] background = {
                " *      *      *      *     ",
                "     *      *     *       * ",
                " *    *      *     *      * ",
